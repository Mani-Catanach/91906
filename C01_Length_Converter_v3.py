...
class Converter:
    ...
    def __init__(self):
        ...
        button_details_list = [
            ["To Celsius", "#990099", lambda:self.check_leng(), 0, 0],
            ["To Fahrenheit", "#009900", lambda:self.check_leng(c.ABS_ZERO_CELSIUS), 0, 1],
    ...
    def convert(self, min_leng, to_convert):
        ...
        if min_leng == c.ABS_ZERO_CELSIUS:
