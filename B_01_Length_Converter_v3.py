    ...
    def __init__(self, partner):
        ...
        if c.MAX_LENGTH != 0:
            help_bounds = ("Note that the maximum and minimum lengths "
                           ...
                           "for both m and cm. If you try to convert a "
                           f"length that is less than {c.MIN_LENGTH} or greater "
                           f"than {c.MAX_LENGTH}, ")
        else:
            help_bounds = (f"Note that {c.MIN_LENGTH} is the minimum length for both "
